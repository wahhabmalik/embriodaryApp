        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ ++$key }}</td>
                        <td>{{ $order->client_orders->client_name }}</a></td>
                        <td>{{ $order->order_date }}</td>
                        {{-- <td>{!! $order->closing_trade_date ?? '<p class="text-danger">OPEN</p>' !!}</td> --}}
                        ...
                        <td class="btn-group">
                            ...
                            <a href="{{ route("edit_order", $order) }}" title="Edit record" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                            
                            <a href="{{ route('order', $order) }}" title="View details" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>

                            <button title="Update record" onclick="openStatusModal({{ $order->order_id }})" class="btn btn-success btn-sm"><i class="fa fa-refresh"></i></button>

                            <form method="POST" action="{{ route('delete_order', $order) }}" style="display: inline-block;">
                                @csrf
                                {{ method_field('DELETE') }}
